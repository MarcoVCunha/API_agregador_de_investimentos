...
class UserServiceTest {
    ...
    class createUser {
        ...
        void shouldCreateUser() {
            ...
            var userCaptored = userArgumentCaptor.getValue();

            assertEquals(input.userName(), userCaptored.getUsername());
            assertEquals(input.email(), userCaptored.getEmail());
            assertEquals(input.password(), userCaptored.getPassword());
    ...
    class listUsers {
        ...
        @Test
        @DisplayName("Should return all users with successes")
        void shouldReturnAllUsersWithSuccesses() {
    ...
    class deleteById {
        ...
        void shouldNotDeleteWhenUserNotSuccess() {
    ...
    class updateUserById {
        ...
        void shouldUpdateUserByIdWhenUseExistsAndPasswordIsFilled() {
